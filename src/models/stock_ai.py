...
class MultimodalStockPredictor(nn.Module):
    ...
    Features:
    - Flexible fusion: 'concat', 'gated', or 'cross_attention' (see fusion_type).
    - Robust input validation and error handling for missing modalities.
    - Interpretability: exposes attention weights and feature importance utilities.
    - Mixed precision training support (see use_mixed_precision).
    - Unit tests included for fusion, input validation, interpretability, and mixed precision.
    ...
    Args:
        ...
        time_series_hidden_dim (int): Hidden dim for time series encoder.
        time_series_out_dim (int): Output dim for time series encoder.
        ...
        use_self_attention (bool): Add transformer encoder layers after feature fusion.
        self_attention_heads (int): Number of heads for self-attention.
        self_attention_layers (int): Number of transformer encoder layers.
        use_dropout_scheduler (bool): Use dropout scheduling during training.
        dropout_scheduler_max (float): Max dropout rate for scheduler.
        dropout_scheduler_min (float): Min dropout rate for scheduler.
        use_stochastic_depth (bool): Use stochastic depth in fusion head.
        stochastic_depth_prob (float): Probability for stochastic depth.
        use_ensemble (bool): If True, use an ensemble of models.
